        ...
        for (let i = 0; i < footerList.length; i++) {
          ...
          if (footerList[i].nombre === "tel") {
            ...
            connectList.push(
              ...
              >
                <img
                  className="footer__connect__foto"
    ...
    return (
      <div className="footer__container">
        ...
        <div className="footer__download__foto__container">
          <a
            className="footer__download__text__link__container"
            href={downloadCopy.urlLink}
            download="Ramiro Santamaria Resume.pdf"
          >
            <h4 className="footer__download__text">Download resume.pdf</h4>
          </a>
          <a
            className="footer__download__foto__link__container"
            href={downloadCopy.urlLink}
            download="Ramiro Santamaria Resume.pdf"
          >
            <img
              className="footer__download__foto"
